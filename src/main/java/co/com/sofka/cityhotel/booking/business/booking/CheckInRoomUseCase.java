...
public class CheckInRoomUseCase implements EventUseCase<AssignedRoom> {

    private final EventsRepository eventsRepository;

    public CheckInRoomUseCase(EventsRepository eventsRepository) {
        this.eventsRepository = eventsRepository;
    }

    @Override
    public List<DomainEvent> apply(AssignedRoom event) {
        ...
        booking.checkInRoom(event.getRoomId(), new RoomAvailable(true));
